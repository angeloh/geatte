 ...
 * 
 */
public class GeatteComing extends Activity {

    private static final String CLASSTAG = GeatteComing.class.getSimpleName();
	...
	Log.v(Config.LOGTAG, " " + GeatteComing.CLASSTAG + " onCreate");
	...
	String geatteId = extras != null ? extras.getString(Config.GEATTE_ID_PARAM) : null;
	...
	Log.d(Config.LOGTAG, " " +  GeatteComing.CLASSTAG + "GOT geatteId = " + geatteId + ", fromNumber = " + fromNumber);
	//	populateFields();
	...
	super.onResume();
	Log.v(Config.LOGTAG, " " + GeatteComing.CLASSTAG + " onResume");
	//populateFields();
    }
